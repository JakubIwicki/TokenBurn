...
GRANT USAGE, CREATE ON SCHEMA metrics TO processor_role;
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA metrics TO processor_role;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA metrics TO processor_role;
ALTER DEFAULT PRIVILEGES IN SCHEMA metrics GRANT ALL ON TABLES TO processor_role;
ALTER DEFAULT PRIVILEGES IN SCHEMA metrics GRANT ALL ON SEQUENCES TO processor_role;

GRANT USAGE ON SCHEMA telemetry TO insights_role;
GRANT USAGE ON SCHEMA search TO insights_role;
GRANT USAGE ON SCHEMA metrics TO insights_role;
...
GRANT SELECT ON ALL TABLES IN SCHEMA metrics TO insights_role;
...
ALTER DEFAULT PRIVILEGES IN SCHEMA metrics GRANT SELECT ON TABLES TO insights_role;
ALTER DEFAULT PRIVILEGES FOR ROLE processor_role IN SCHEMA metrics GRANT SELECT ON TABLES TO insights_role;
SQL
