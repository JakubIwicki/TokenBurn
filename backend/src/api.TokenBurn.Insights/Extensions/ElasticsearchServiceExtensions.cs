...
///     tests never resolve the client and stay inert. Per-project copy rather
///     than a Common registration because the kernel must stay dependency-free
///     (<c>DependencyDirectionConvention</c>).
/// </summary>
public static class ElasticsearchServiceExtensions
{
    public static IServiceCollection AddInsightsElasticsearchClient(
